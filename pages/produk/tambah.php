            ...
            <div class="col-md-6">
                ...
                <form method="POST" action="" enctype="multipart/form-data">
                    ...
                    <div class="form-group <?php echo (!empty($file_img)) ?  'has-error' : ''; ?>">
                        ...
                        <div class="col-sm-10">
                            <input type="file" class="form-control" accept="image/x-png,image/gif,image/jpeg" value="<?php echo isset($data['file_img']) ? $data['file_img'] : 'tidak ada gambar'; ?>" name="file_img">
